        ...
        {/* left/top div */}
           ...
           px-[10px]'>
              <span className='text-[35px] font-semibold '>Explore</span>
               ...
               <p className='text-[17px]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Pariatur, nostrum. Molestiae ?</p>
               <button className='px-[20px] py-[10px] border-2 bg-[black] border-white text-white rounded-[10px] 
               text-[18px] flex font-light gap-2 mt-[40px] cursor-pointer'>Explore Courses<SiViaplay className='w-[30px] h-[30px] lg:fill-white fill-black'/></button>
